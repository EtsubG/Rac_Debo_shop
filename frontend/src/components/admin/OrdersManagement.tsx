...
import { Badge, Button, Textarea } from '@/components/ui/Button';
...
export function OrdersManagement(_props: OrdersManagementProps) {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const response = await approveOrder(selectedOrder.id);
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-xs text-navy-400 mt-1">
            Manage customer orders and verify payment proofs.
          </p>
        </div>
            ...
            {!rejectMode ? (
              <>
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <Badge color={statusColor(selectedOrder.status)}>
                ...
                {/* Payment actions */}
                {(selectedOrder.status === 'Proof Uploaded' ||
